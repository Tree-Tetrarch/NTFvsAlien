/obj/machinery/vending/weapon
	...
	products = list(
		"Rifles" = list(
			...
			/obj/item/weapon/gun/rifle/nt_halter/cqb = -1,
		...
		"Shotgun" = list(
			...
			/obj/item/ammo_magazine/rifle/sh410_gas = -1,
		),
		"Machinegun" = list(
		...
		"Specialized" = list(
			...
			/obj/item/storage/holster/backholster/rpg = 4,
			/obj/item/weapon/gun/launcher/rocket/recoillessrifle = 4,
			/obj/item/ammo_magazine/rocket/recoilless = 10,
			/obj/item/ammo_magazine/rocket/recoilless/light = 10,
			/obj/item/ammo_magazine/rocket/recoilless/low_impact = 8,
			/obj/item/ammo_magazine/rocket/recoilless/smoke = 16,
			/obj/item/ammo_magazine/rocket/recoilless/cloak = 8,
			/obj/item/ammo_magazine/rocket/recoilless/plasmaloss = 8,
			/obj/item/ammo_magazine/rocket/recoilless/heat = 8,
			/obj/item/ammo_magazine/rocket/recoilless/heam = 8,
		),
		"Heavy Weapons" = list(
		...
		"Boxes" = list(
			...
			/obj/item/ammo_magazine/packet/halter = -1,
			/obj/item/ammo_magazine/packet/halter/laser = -1,
...
/obj/machinery/vending/weapon/crash
	products = list(
		...
		"Melee" = list(
			...
			/obj/item/weapon/shield/riot/marine/deployable = 6,
			/obj/item/weapon/combat_knife/harvester = 12,
			/obj/item/weapon/energy/sword/ntc = 1,
		),
		"Sidearm" = list(
			/obj/item/weapon/gun/pistol/standard_pistol = -1,
			/obj/item/ammo_magazine/pistol/standard_pistol = -1,
			...
			/obj/item/weapon/gun/pistol/xmdivider/ntc = 2,
			/obj/item/ammo_magazine/pistol/ntunity = 20,
		),
		"Grenades" = list(
			/obj/item/weapon/gun/grenade_launcher/single_shot = -1,
			/obj/item/weapon/gun/grenade_launcher/multinade_launcher/unloaded = -1,
		...
		"Boxes" = list(
			...
			/obj/item/ammo_magazine/packet/p10x265mm = -1,
			/obj/item/ammo_magazine/packet/halter = -1,
			/obj/item/ammo_magazine/packet/halter/rubber = -1,
			/obj/item/ammo_magazine/packet/halter/laser = -1,
			/obj/item/ammo_magazine/packet/p10x27mm = -1,
			/obj/item/ammo_magazine/packet/p492x34mm = -1,
			/obj/item/ammo_magazine/packet/p86x70mm = -1,
...
/obj/machinery/vending/weapon/valhalla
	...
	products = list(
		...
		"Grenades" = list(
			...
			/obj/item/explosive/grenade/emp = -1,
...
//			/obj/item/armor_module/module/hod_head = -1,
			...
			/obj/item/armor_module/module/eshield/absorbant/energy = 2,
...
/obj/machinery/vending/valhalla_seasonal_req
	...
	products = list(
		"Seasonal" = list(
			...
			/obj/item/ammo_magazine/rifle/m16_quadstack = -1,
			/obj/item/ammo_magazine/rifle/m16_cmag = -1,
		...
		"Sons of Mars" = list(
			...
			/obj/item/ammo_magazine/flamer_tank/large/som = 30,
		),
		"CM" = list(
