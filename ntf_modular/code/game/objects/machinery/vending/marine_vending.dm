...
/*		/obj/item/armor_module/module/style/superheavy_armor,*/
		...
		"General" = list(
			...
			/obj/item/clothing/suit/modular/goon = -1,
...
/obj/machinery/vending/weapon/vsd
	...
	products = list(
		"Rifles" = list(
			...
			/obj/item/ammo_magazine/rifle/vsd_carbine/rubber/extended = 20,
...
/obj/machinery/vending/uniform_supply/icc
	...
	products = list(
		"Standard" = list(
			...
			/obj/item/armor_module/armor/cape = -1,
			/obj/item/armor_module/armor/cape/kama = -1,
			/obj/item/clothing/under/marine/veteran/cm/medic = -1,
			/obj/item/clothing/under/marine/veteran/cm = -1,
		),
		"Webbings" = list(
			/obj/item/armor_module/storage/uniform/black_vest = -1,
			/obj/item/armor_module/storage/uniform/black_vest/sling = -1,
...
/obj/machinery/vending/uniform_supply/icc/clf
	products = list(
		"Disguises" = list(
			...
			/obj/item/clothing/head/securitycap = 2,
			...
			/obj/item/clothing/under/liaison_suit = 1,
			/obj/item/storage/backpack/satchel/norm = 7,
			/obj/item/clothing/under/rank/scientist = 2,
			/obj/item/clothing/suit/storage/labcoat/researcher = 2,
			/obj/item/storage/pouch/surgery = 2,
			/obj/item/storage/backpack/toxins = 2,
			/obj/item/clothing/glasses/hud/health = 2,
			/obj/item/storage/belt/rig = 1,
			/obj/item/clothing/mask/surgical = 2,
			/obj/item/clothing/suit/armor/vest = 3,
			/obj/item/clothing/head/chefhat = 1,
			/obj/item/clothing/suit/storage/chef = 1,
			...
			/obj/item/clothing/head/helmet/space/rig/mining = 1,
			/obj/item/clothing/glasses/meson = 1,
			/obj/item/clothing/gloves/ruggedgloves = 2,
			/obj/item/weapon/twohanded/sledgehammer = 1,
			/obj/item/clothing/suit/space/rig/mining = 1,
			/obj/item/clothing/under/lawyer/purpsuit = 1,
			/obj/item/clothing/suit/storage/lawyer/purpjacket = 1,
			...
			/obj/item/clothing/suit/storage/CMB = 1,
			...
			/obj/item/clothing/suit/storage/labcoat/chemist = 1,
			/obj/item/storage/backpack/satchel/chem = 1,
			/obj/item/storage/belt/hypospraybelt = 1,
			...
			/obj/item/clothing/suit/storage/labcoat/science = 2,
			...
			/obj/item/clothing/mask/gas/modular/skimask = 5,
			/obj/item/clothing/under/lewd/stripper = 1,
			/obj/item/clothing/shoes/high_heels/red = 1,
			/obj/item/clothing/head/bunny_ears = 1,
			/obj/item/clothing/under/dress/maid = 1,
			...
			/obj/item/clothing/under/rank/synthetic = 1,
		...
		"Standard" = list(
			...
			/obj/item/clothing/gloves/marine/fingerless = -1,
			/obj/item/clothing/gloves/marine/black = -1,
			/obj/item/clothing/shoes/marine/clf = -1,
			/obj/item/clothing/gloves/marine/hyperscale = -1,
			/obj/item/clothing/shoes/cowboy = -1,
			/obj/item/armor_module/armor/badge = -1,
			/obj/item/armor_module/armor/cape = -1,
...
/obj/machinery/vending/armor_supply/icc/clf
	products = list(
		"Militia standard issue" = list(
			/obj/item/clothing/suit/modular/xenonauten/light/bikini/neutral/icc = 3,
			/obj/item/clothing/suit/storage/faction/militia = 5,
...
/obj/machinery/vending/weapon/clf
	name = "Cult weapon stash"
	desc = "A stash filled with weapons perfect for serving our xock lords! Mostly same weapons as ICC since Cult is sort of a detachment of it."
	icon_state = "marinearmory"
	icon_vend = "marinearmory-vend"
	icon_deny = "marinearmory"
	wrenchable = FALSE
	...
	//want give that true limited stash feelin trust
	products = list(
		"Rifles" = list(
			/obj/item/weapon/gun/rifle/icc_sharpshooter = 1,
			/obj/item/ammo_magazine/rifle/icc_sharpshooter = -1,
		...
		"SMGs" = list(
			...
			/obj/item/ammo_magazine/smg/som/ap = 8,
			/obj/item/ammo_magazine/smg/som/incendiary = 5,
			/obj/item/ammo_magazine/smg/som/squashhead = 3,
			/obj/item/weapon/gun/smg/icc_machinepistol = 7,
			/obj/item/ammo_magazine/smg/icc_machinepistol = -1,
		...
		"Sidearm" = list(
			...
			/obj/item/ammo_magazine/pistol/g22tranq = 4,
		),
		"Grenades" = list(
			...
			/obj/item/explosive/grenade/sticky = 20,
			/obj/item/explosive/grenade/sticky/trailblazer = 35,
			/obj/item/explosive/grenade/incendiary = 10,
			/obj/item/explosive/grenade/smokebomb = 10,
			/obj/item/explosive/grenade/smokebomb/cloak = 10,
			/obj/item/explosive/grenade/smokebomb/antigas = 3,
			/obj/item/explosive/grenade/sticky/cloaker = 15,
			/obj/item/explosive/grenade/smokebomb/drain = 5,
			/obj/item/explosive/grenade/mirage = 15,
			/obj/item/explosive/grenade/training = -1,
			/obj/item/explosive/grenade/impact = 20,
			/obj/item/explosive/grenade/phosphorus = 3,
			/obj/item/explosive/grenade/chem_grenade/metalfoam = 5,
			/obj/item/explosive/grenade/smokebomb/neuro = 10,
			/obj/item/explosive/grenade/smokebomb/neuro/alt = 5,
			/obj/item/explosive/grenade/smokebomb/acid = 5,
			/obj/item/explosive/grenade/smokebomb/satrapine = 5,
			/obj/item/explosive/grenade/smokebomb/aphrotoxin = 10,
			/obj/item/explosive/grenade/flashbang/stun = 10,
			/obj/item/explosive/grenade/smokebomb/sleep = 7,
			/obj/item/explosive/grenade/bullet/laser = 8,
			/obj/item/explosive/grenade/bullet/hefa = 3,
			/obj/item/explosive/grenade/emp = 2,
			/obj/item/explosive/grenade/cagenade = 3,
			/obj/item/storage/box/m94 = 50,
			//ample suppy of ghetto ass grenades
			/obj/item/explosive/grenade/incendiary/molotov = 50,
			/obj/item/explosive/grenade/stick = 50,
		),
		"Heavy Weapons" = list(
