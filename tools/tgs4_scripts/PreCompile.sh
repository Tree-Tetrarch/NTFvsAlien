...
printf "#define DEFINE_REVINFO_REVISION \"" >> _ntf_modular/code/__DEFINES/revinfo.dm
(git rev-parse HEAD |  tr -d '\n') >> _ntf_modular/code/__DEFINES/revinfo.dm
printf "\"\r\n#define DEFINE_REVINFO_COMPILE_DATE \"" >> _ntf_modular/code/__DEFINES/revinfo.dm
...
echo "//Do not edit manually" > _ntf_modular/code/__DEFINES/revinfo.dm
